...
function execute(schema, documentAST, rootValue, contextValue, variableValues, operationName) {
  ...
  console.log('documentAST', documentAST);
...
function executeOperation(exeContext, operation, rootValue) {
  ...
  console.log(computeComplexity(exeContext, type, rootValue, fields));
 ...
 * for "read" mode.
 */
function computeComplexity(exeContext, parentType, sourceValue, fields) {
  console.log('computeComplexity');
  console.log((0, _keys2.default)(fields));
  return (0, _keys2.default)(fields).reduce(function (sum, responseName) {
    var fieldASTs = fields[responseName];
    var result = computeFieldComplexity(exeContext, parentType, sourceValue, fieldASTs);
    return sum + result;
  }, 0);
}
 ...
 */
function computeFieldComplexity(exeContext, parentType, source, fieldASTs) {
  console.log('computeFieldComplexity');
  var fieldAST = fieldASTs[0];
  var fieldName = fieldAST.name.value;
  console.log('fieldAST', fieldAST);
